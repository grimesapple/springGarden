...
import com.djq.springGarden.eum.ResultMessage;
...
public class ResultVO<T> implements Serializable {
    ...
    public static <T> ResultVO<T>ok(T result) {
        return new ResultVO<T>(CODE, result, ResultMessage.DEF_SUCCESS.getMessage());
    }

    public static <T> ResultVO<T>ok(T result, String msg) {
    ...
    public static <T> ResultVO<T>callBackError(String msg) {
    ...
    public static <T> ResultVO<T>error(T result) {
        return new ResultVO<T>(CODE, result, ResultMessage.DEF_ERROR.getMessage());
    }

    public static <T> ResultVO<T>error(Integer code, T result, String msg) {
        return new ResultVO<T>(code, result, msg);
    }
