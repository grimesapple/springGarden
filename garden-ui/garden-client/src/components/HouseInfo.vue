	...
	<section class="g-createHouse-layout">
		...
		<div class="g-comStepNav-layout">
			<el-steps :active="active" finish-status="success" class="step-nav">
				...
				<!--配套列表，房型列表-->
				<el-step title="房间照片"></el-step>
				<!--图片，描述-->
				<el-step title="房间描述"></el-step>
			</el-steps>
		</div>
		<!--内容-->
		...
		<section class="g-hcComModal-layout" v-show="active===0">
			<div class="situation-item">
				...
				<div class="item-contain">
					<el-input v-model="name" placeholder="请输入房间号" style="width: 300px" size="small" maxlength="20"
						clearable></el-input>
				</div>
				<div class="item-title">
					<h2>房间标题</h2>
				...
				<div class="item-contain">
					<el-input v-model="subTitle" placeholder="请输入标题" style="width: 300px" size="small" maxlength="20"
						clearable></el-input>
				</div>
				<!--                <div class="item-contain">
