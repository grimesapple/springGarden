						...
						<div class="content">
							<div class="item-house-info">
								...
								<div class="info-right">
									...
									<div class="desc">{{item.houseType}}居{{item.bedNumber}}床{{item.peopleNumber}}人
										{{item.cityAndRegion}}</div>
								</div>
							</div>
							...
							<div class="item-operation">
								<div style="margin-top: 15px">
									<el-button size="mini" type="info" @click="toDetail(item)">查看详情</el-button>
								</div>
							</div>
							<div class="item-operation">
								<div style="margin-bottom: 5px">
									<el-button size="mini" type="warning" @click="updateHouse(item)">修改房屋</el-button>
								</div>
								<div>
									<el-button size="mini" type="danger" :disabled="item.state==3 || !allowShelf[key]"
										@click="offShelf(item)">下架房屋</el-button>
								</div>
							</div>
						</div>
					</div>
