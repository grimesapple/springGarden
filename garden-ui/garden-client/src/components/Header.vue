...
<template>
	...
	<div class="hc-home-header-wrapper">
		<div class="hc-header">
			<div class="logo-area">
				<a href="/">
					<img src="../assets/img/upload/static/logo.png" alt="青庭民宿">
				</a>
			</div>
			<div class="slot-area">
			...
			<div class="tools-area">
				<div class="tools-item">
					<el-button type="success" round @click="showLogin=true" v-if="!this.$store.state.isLogin">注册/登录
					</el-button>
				</div>
				<div class="tools-item" v-if="this.$store.state.isLogin">
						...
						<el-dropdown-menu slot="dropdown" class="dropdown-notice">
							...
							<div class="classified-contain">
								<div class="classified-contain-wrapper">
									<div class="classified-contain-item" v-for="(item,key) in notice"
										v-show="item.noticeType===showNoticeType">
